...
这个与前面的DebugEntry有一些区别，区别在于：`InvalidTSSEntry`是一个有返回错误码的中断，intel的cpu直接隐式的帮助我们将错误码push到栈中了，所以我们就不需要重复push了，我们之前的时候push 0 实际上就是将`error_code`置为了0.
...
<img src="https://goleveldb-1301596189.cos.ap-guangzhou.myqcloud.com/05.d04z.010.png" alt="img" style="zoom: 50%;" />
...
<img src="https://goleveldb-1301596189.cos.ap-guangzhou.myqcloud.com/image-20201026024056882.png" alt="image-20201026024056882" style="zoom:67%;" />
...
<img src="https://goleveldb-1301596189.cos.ap-guangzhou.myqcloud.com/操作系统启动流程.png" style="zoom: 33%;" />
...
<img src="https://goleveldb-1301596189.cos.ap-guangzhou.myqcloud.com/image-20201027005727113.png" alt="image-20201027005727113" style="zoom:50%;" />
...
<img src="https://goleveldb-1301596189.cos.ap-guangzhou.myqcloud.com/image-20201027115027420.png" alt="image-20201027115027420" style="zoom:67%;" />
...
<img src="https://goleveldb-1301596189.cos.ap-guangzhou.myqcloud.com/向后对齐方式.png" style="zoom: 33%;" />
...
<img src="https://goleveldb-1301596189.cos.ap-guangzhou.myqcloud.com/image-20201027144920851.png" alt="image-20201027144920851" style="zoom:67%;" />
...
<img src="https://goleveldb-1301596189.cos.ap-guangzhou.myqcloud.com/image-20201028175808354.png" alt="image-20201028175808354" style="zoom:67%;" />
...
<img src="https://goleveldb-1301596189.cos.ap-guangzhou.myqcloud.com/image-20201028180730562.png" alt="image-20201028180730562" style="zoom:67%;" />
...
<img src="https://goleveldb-1301596189.cos.ap-guangzhou.myqcloud.com/image-20201028235015837.png" alt="image-20201028235015837" style="zoom:67%;" />
...
<img src="https://goleveldb-1301596189.cos.ap-guangzhou.myqcloud.com/image-20201029010044909.png" alt="image-20201029010044909" style="zoom:50%;" />
...
<img src="https://goleveldb-1301596189.cos.ap-guangzhou.myqcloud.com/不能完成的情况.png" style="zoom: 25%;" />
...
<img src="https://goleveldb-1301596189.cos.ap-guangzhou.myqcloud.com/image-20201029035159870.png" alt="image-20201029035159870" style="zoom:67%;" />

额，我们输出的太多了，效果非常不好，于是我决定把前面乱输出的给去了，最后显示如下：

<img src="https://goleveldb-1301596189.cos.ap-guangzhou.myqcloud.com/image-20201029035526447.png" alt="image-20201029035526447" style="zoom:67%;" />
...
<img src="https://goleveldb-1301596189.cos.ap-guangzhou.myqcloud.com/05.d04z.018.png" alt="img" style="zoom:50%;" />
...
<img src="https://goleveldb-1301596189.cos.ap-guangzhou.myqcloud.com/05.d04z.019.png" alt="img" style="zoom:50%;" />
...
- **与CPU之间第一次握手**：正在��务寄存器接到新的事件并且存储结束后，会向CPU发送INT中断（上升沿），CPU返回`INTA`信号，表示收到
...
到此为止，我们对中断的初始化就告一段落了，接下来就写一个函数`DoIRQ`来处理中断即可：
...
在makefile中添加新建的`interrupt`，并且在`main.c`中进行引入，在`main.c`中调用`InitInterrupt`函数进行中断函数的初始化，执行后结果如下：

<img src="https://goleveldb-1301596189.cos.ap-guangzhou.myqcloud.com/image-20201029204128754.png" alt="image-20201029204128754" style="zoom:50%;" />
...
<img src="https://goleveldb-1301596189.cos.ap-guangzhou.myqcloud.com/image-20201029204708809.png" alt="image-20201029204708809" style="zoom:50%;" />
...
<img src="https://goleveldb-1301596189.cos.ap-guangzhou.myqcloud.com/05.d04z.021.png" alt="img" style="zoom: 25%;" />
...
<img src="https://goleveldb-1301596189.cos.ap-guangzhou.myqcloud.com/image-20201029234240137.png" alt="image-20201029234240137" style="zoom:50%;" />
...
<img src="https://goleveldb-1301596189.cos.ap-guangzhou.myqcloud.com/进程管理框架.png" style="zoom: 25%;" />
...
<img src="https://goleveldb-1301596189.cos.ap-guangzhou.myqcloud.com/task_union内存情况.png" style="zoom: 25%;" />
...
![image](https://goleveldb-1301596189.cos.ap-guangzhou.myqcloud.com/281409208002531.png)
    ...
    unsigned long DoFork(struct PTRegs * regs, unsigned long clone_flags, unsigned long stack_start, unsigned long stack_size) {
    	...
    	*tsk = *current;
    	...
    	if (!(tsk->flags & PF_KTHREAD)) // 进程运行于应用层空间， 就将预执行函数设置为： ResetFromInterrupt
    		thd->rip = regs->rip = (unsigned long)ResetFromInterrupt;
...
<img src="https://goleveldb-1301596189.cos.ap-guangzhou.myqcloud.com/image-20201106194426641.png" alt="image-20201106194426641" style="zoom:80%;" />
